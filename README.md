...
- [3. Run Gabriel](#3-run-gabriel)
  ...
  - [3.4. monitor new raw block events](#34-monitor-new-raw-block-events)
...
### 3.4. monitor new raw block events
...
2. Create a tx w/ P2PK output:
        ...
        $ export BITCOIND_RPC_URL=http://127.0.0.1:18443 \
            && export BITCOIND_RPC_COOKIE=/path/to/bitcoind/datadir/regtest/.cookie
